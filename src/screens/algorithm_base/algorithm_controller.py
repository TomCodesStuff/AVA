...
from src.thread_handlers import AlgorithmThread, ManagedThread
from src.data_structures import DataStructure
from src.enums import AlgorithmType


if TYPE_CHECKING:
    from src.screens.algorithm_base import AlgorithmScreen, AlgorithmModel
...
class AlgorithmController(ABC, Generic[S, M, D]):  
    ...
    def startAlgorithmThread(self, algorithmType : AlgorithmType, algorithmName : str) -> None:    
        ...
        # Start running algorithm thread, so this project has as use 
